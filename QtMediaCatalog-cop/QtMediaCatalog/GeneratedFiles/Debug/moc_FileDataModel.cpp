...
QT_MOC_LITERAL(6, 55, 14), // "noFilesChoosen"
QT_MOC_LITERAL(7, 70, 13), // "addFilesToDir"
QT_MOC_LITERAL(8, 84, 7), // "dirName"
QT_MOC_LITERAL(9, 92, 10), // "QList<int>"
QT_MOC_LITERAL(10, 103, 7), // "chfiles"
QT_MOC_LITERAL(11, 111, 13) // "SendFilesList"

    },
    "FileDataModel\0isFileChecked\0\0check\0"
    "fileChoosen\0choosen\0noFilesChoosen\0"
    "addFilesToDir\0dirName\0QList<int>\0"
    "chfiles\0SendFilesList"
};
...
void FileDataModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->noFilesChoosen(); break;
        case 3: _t->addFilesToDir((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QList<int>(*)>(_a[2]))); break;
        case 4: _t->SendFilesList((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (FileDataModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileDataModel::noFilesChoosen)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void FileDataModel::noFilesChoosen()
{
